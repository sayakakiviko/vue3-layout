...
<template>
  <div class="home page-wrap">
    <h1>欢迎</h1>
    <el-button v-jump="['/other/detail/1', {}, 'params']">多开详情页1</el-button>
    <el-button v-jump="['detail', { id: 2 }, 'params']">多开详情页2</el-button>
    <el-button v-jump="['detail', { id: 3 }, 'params']">多开详情页3</el-button>
